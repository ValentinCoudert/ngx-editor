(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs/Subject'), require('rxjs/add/operator/map'), require('@angular/forms'), require('codemirror'), require('codemirror/addon/display/placeholder.js'), require('codemirror/mode/htmlmixed/htmlmixed.js'), require('ngx-bootstrap'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('ngx-editor', ['exports', '@angular/core', '@angular/common/http', 'rxjs/Subject', 'rxjs/add/operator/map', '@angular/forms', 'codemirror', 'codemirror/addon/display/placeholder.js', 'codemirror/mode/htmlmixed/htmlmixed.js', 'ngx-bootstrap', '@angular/common'], factory) :
	(factory((global['ngx-editor'] = {}),global.ng.core,global.ng.common.http,global.Rx,global.Rx.Observable.prototype,global.ng.forms,global.codemirror,null,null,global['ngx-bootstrap'],global.ng.common));
}(this, (function (exports,core,http,Subject,map,forms,codemirror,placeholder_js,htmlmixed_js,ngxBootstrap,common) { 'use strict';
...
var NgxEditorToolbarComponent =               (function () {
    ...
    NgxEditorToolbarComponent.prototype.ngOnInit = function () {
        ...
        this.buildImageForm();
        this.buildVideoForm();
        this.possibleFonts = fonts.sort(function (font1, font2) {
